...
"""
        ...
        print(f"PR creation result: success={result.get('success', False)}")
        if not result.get("success"):
            error_detail = result.get("error", "Unknown error")
            print(f"PR creation failed: {error_detail}")
        ...
        if result.get("success"):
            ...
            state.status = "done"
            print(f"❌ PR creation failed: {state.error}")
        ...
        state.status = "done"
        print(f"❌ Exception in PR creation: {e}")
